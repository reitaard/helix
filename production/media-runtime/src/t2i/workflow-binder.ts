 ...
 */
export interface T2IWorkflow extends
  Record<string, Record<string, unknown>> {}

export function bindT2IWorkflow(
  _workflow: T2IWorkflow,
  _prompt: string,
  _settings: ResolvedT2ISettings
): never {
  throw new Error(
    "T2I workflow binding is unavailable until the vetted FLUX API workflow is supplied"
  );
}
