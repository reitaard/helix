...
Status: **feature branch implemented; VPS build/test, migration 0013, runtime deployment, and Telegram smoke test still pending.**
...
Migration `0013_telegram_job_lifecycle.sql` adds:
...
**Migration 0013 is not applied to Production at this checkpoint.** Production remains at migration 0012 until branch validation is complete.
...
- migration 0013 durability contract;
...
migration 0013 apply + verification
